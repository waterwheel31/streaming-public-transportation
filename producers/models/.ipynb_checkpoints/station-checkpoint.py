...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        print('station_id:', station_id, 'station_name:', station_name, 'topic_name:', topic_name)
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        print('train:',train, 'direction:', direction, 'prev_staion_id:', prev_station_id, 'prev_direction:', prev_direction)
